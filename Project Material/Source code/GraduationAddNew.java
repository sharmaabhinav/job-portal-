 ...
 * @author RAGHU
 */
@WebServlet(name="GraduationAddNew", urlPatterns={"/GraduationAddNew"})
public class GraduationAddNew extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try{
            ...
            out.println(" "+Degree+" "+Branch+" "+Duration+" "+Institute+" "+University+" "+YOB+" "+YOP+" "+ScoreType+" "+Value+" ");
             ...
             String query1 = "insert into Graduation values('"+regId+"'"
                      + ",'" + Degree+ "'"
                      + ",'" + Branch +"'"
                      + ",'" +Institute + "'"
                      + ",'" +University + "'"
