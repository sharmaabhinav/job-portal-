 ...
 * @author apsingh
 */
@WebServlet(name="GraduationRemove", urlPatterns={"/GraduationRemove"})
public class GraduationRemove extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try
        {
            String query="delete from Graduation where StudentID='"+regId+"' and Degree='"+Deg+"' and Branch='"+Branch+"'";
